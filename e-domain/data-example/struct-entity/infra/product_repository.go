...
type ProductRepository struct {
	...
	companyBelongToRepository  data.BelongToRepository[domain.Product, domain.Company]
	categoryBelongToRepository data.BelongToRepository[domain.Product, domain.Category]
}
...
func (p *ProductRepository) FindByCompany(ctx context.Context, company domain.Company) ([]domain.Product, error) {
	return p.companyBelongToRepository.FindBy(ctx, company)
}

func (p *ProductRepository) FindByCategory(ctx context.Context, category domain.Category) ([]domain.Product, error) {
	return p.categoryBelongToRepository.FindBy(ctx, category)
}
